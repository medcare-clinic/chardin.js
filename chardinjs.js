  ...
  (function($, window) {
    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype._position_helper_layer = function(element) {
        var __height, __width, element_position, helper_layer;
        helper_layer = $(element).data('helper_layer');
        element_position = this._get_offset(element);
        __width = element_position.width;
        if (this._get_position(element) === "right" || this._get_position(element) === "left") {
          __width += 10;
        }
        __height = element_position.height;
        if (this._get_position(element) === "top" || this._get_position(element) === "bottom") {
          __height += 10;
        }
        return helper_layer.setAttribute("style", "width: " + __width + "px; height:" + __height + "px; top:" + element_position.top + "px; left: " + element_position.left + "px;");
      };
